...
## @brief Получить путь до директории размещения скриптов запуска системных сервисов
...
## @brief Получить путь до директории размещения скриптов запуска пользовательских сервисов
## @param [in] Имя пользователя, необязательный аргумент (если не задано, будет подставлено имя текущего пользователя)
## @return Путь до директории размещения скриптов запуска пользовательских сервисов
## @retval 0 - успешно
